...
ENV CROSS_TOOLCHAIN_ROOT=/opt/osxcross
ENV TARGET_OS=macos
...
set(CMAKE_C_COMPILER "${CROSS_TOOLCHAIN_ROOT}/bin/${CROSS_COMPILE}-cc")
set(CMAKE_CXX_COMPILER "${CROSS_TOOLCHAIN_ROOT}/bin/${CROSS_COMPILE}-c++")
